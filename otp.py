...
SMTP_PORT = 587
USERNAME = 'purnakothapalli148@gmail.com'  # Use environment variables for security
PASSWORD = 'pzvw fyfu euol pxcb'     # Replace with your email password or app password
